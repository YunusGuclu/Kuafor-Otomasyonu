...
namespace Kuaför
{
    public partial class Randevu_Yönetimi : Form
    {
        public Randevu_Yönetimi()
        {
            InitializeComponent();
        }
        ...
        private void Randevu_Yönetimi_Load(object sender, EventArgs e)
        {
            listele();
        ...
        private void btn_Ekle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    baglanti.Open();                   
                    // Kullanıcının seçtiği randevu tarihi ve saati
